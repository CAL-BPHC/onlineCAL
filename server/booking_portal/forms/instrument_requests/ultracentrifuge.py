    ...
    class Meta(UserDetailsForm.Meta, UserRemarkForm.Meta):
        ...
        widgets = dict(
            ...
            **{
                ...
                "rotor_used": forms.Select(attrs={"class": "form-control", }),
                "solvent": forms.TextInput(attrs={"class": "form-control", }),
                "tubes_used": forms.TextInput(attrs={"class": "form-control", }),
                "utilization_of_rotor":forms.TextInput(attrs={"class": "form-control", }),
